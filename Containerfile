...
RUN wget -c https://github.com/bikass/kora/archive/refs/tags/v1.6.2.zip
RUN unzip -o -qq v1.6.2.zip 'kora-1.6.2/kora/*' 'kora-1.6.2/kora-light/*' 'kora-1.6.2/kora-light-panel/*' 'kora-1.6.2/kora-pgrey/*' -d .
RUN mv ./kora-1.6.2/kora /usr/share/icons/
RUN mv ./kora-1.6.2/kora-light /usr/share/icons/
RUN mv ./kora-1.6.2/kora-light-panel /usr/share/icons/
RUN mv ./kora-1.6.2/kora-pgrey /usr/share/icons/
RUN rm -rf ./kora-1.6.2 ./v1.6.2.zip
...
cosmic-osd cosmic-panel cosmic-randr cosmic-screenshot cosmic-session cosmic-settings cosmic-settings-daemon cosmic-store cosmic-term cosmic-workspaces xdg-desktop-portal-cosmic
