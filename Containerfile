...
RUN wget https://copr.fedorainfracloud.org/coprs/nickavem/mozilla-vpn-client/repo/fedora-39/nickavem-mozilla-vpn-client-fedora-39.repo -O /etc/yum.repos.d/nickavem-mozillavpn-copr.repo
...
RUN rm -f /etc/yum.repos.d/nickavem-mozillavpn-copr.repo
